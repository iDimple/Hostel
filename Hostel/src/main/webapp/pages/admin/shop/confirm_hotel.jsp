...
<script>
    ...
    function initItem() {
        $(".button-pass").click(function () {
            ...
            $.ajax({
                type: "POST",
                url: "http://localhost:8080/Hostel/admin/manager/new/pass",
                data: {
                    applyid: applyid
                },
                success: function (data) {
                    if (data["success"] == false) {
                        ...
                        setTimeout(function () {
                            window.location.href = "http://localhost:8080/Hostel/admin/manager/approval";
                        }, 1000);
                    }
                },
                error: function () {
        ...
        $(".button-reject").click(function () {
            ...
            $.ajax({
                type: "POST",
                url: "http://localhost:8080/Hostel/admin/manager/reject",
                data: {
                    applyid: applyid
                },
                success: function (data) {
        ...
        $(".button-modify-pass").click(function () {
            ...
            $.ajax({
                type: "POST",
                url: "http://localhost:8080/Hostel/admin/manager/modify/pass",
                data: {
                    applyid: applyid
                },
                success: function (data) {
