...
<script>
    ...
    function noBook() {
        $.ajax({
            type: "POST",
            url: "http://localhost:8080/Hostel/admin/hall/getAvail",
    ...
    function getBook() {
        $.ajax({
            type: "POST",
            url: "http://localhost:8080/Hostel/admin/hall/getBooks",
            data: {
    ...
    function getAllBook() {
        $.ajax({
            type: "POST",
            url: "http://localhost:8080/Hostel/admin/hall/getAllBooks",
            success: function (data) {
                var bookList = data.list;
                if (bookList.length == 0) {
    ...
    function vipCashCheckin(bookid) {
        ...
        if (flag == true) {
            $.ajax({
                type: "POST",
                url: "http://localhost:8080/Hostel/admin/hall/vipCashCheckin",
                data: {
                    bookid: bookid,
                },
                success: function (data) {
                    if (data["success"] == false) {
                        ...
                        setTimeout(function () {
                            window.location.href = "http://localhost:8080/Hostel/admin/hall";
                        }, 1000);
                    }
                },
                error: function () {
    ...
    function vipCheckin(bookid) {
        ...
        if (flag == true) {
            $.ajax({
                type: "POST",
                url: "http://localhost:8080/Hostel/admin/hall/vipCheckin",
                data: {
                    bookid: bookid,
                },
                success: function (data) {
    ...
    function nonVipPage(planid) {
        window.location.href = "http://localhost:8080/Hostel/admin/hall/nonVipCheckin?planid=" + planid;
    }
