...
<script>
    ...
    function getProducts(key) {
        $.ajax({
            type: "GET",
            url: "http://localhost:8080/Hostel/getProducts",
            data: {
                key: key
            },
            success: function (data) {
                ...
                for (var i = 0; i < list.length; i++) {
                    var html =
                            ...
                            '<img src="http://localhost:8080/Hostel/' + list[i].imgPath + '" class="product-img">' +
                ...
                $("#product-panel").children(".product-card").click(function () {
                    window.location.href = "http://localhost:8080/Hostel/product?hid=" + $(this).attr("productId");
                });
