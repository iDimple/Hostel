    ...
    <div class="content">
        <div class="product-container">
            <div class="product-intro">
                <img src="http://localhost:8080/Hostel/${product.imgPath}" class="product-img"/>
                <div class="intro">
                    ...
                    <div class="table-container">
                        <table id="js-table" class="table table-striped table-bordered">
                            ...
                            <c:forEach items="${planItems}" var="item">
                                <tr>
                                    <td>
                                        <img src="http://localhost:8080/Hostel/assets/img/标准间.jpg" class="room-img">
                                          <!--  <img src="http://localhost:8080/Hostel/assets/img/大床房.jpg" class="room-img">
                                            <img src="http://localhost:8080/Hostel/assets/img/套房.jpg" class="room-img"> 
                                   -->  </td>
...
<script>
    ...
    function initItem() {
        $(".button-book").click(function () {
            ...
            $.ajax({
                type: "POST",
                async: false,
                url: "http://localhost:8080/Hostel/product/check",
                data: {
                    planid: planid,
                    names: names,
                },
                ...
                success: function (data) {
                    if (data["success"] == false) {
                        ...
                        $.ajax({
                            type: "GET",
                            async: false,
                            url: "http://localhost:8080/Hostel/product/book",
                            data: {
                                planid: planid,
                                names: names,
                            },
                            success: function (data) {
                                if (data["success"] == false) {
                                    ...
                                    setTimeout(function () {
                                        window.location.href = "http://localhost:8080/Hostel/product/book?planid=" + planid + "&names=" + names;
                                    }, 1000);
                                }
                            },
                            error: function () {
    ...
    function getPlansByDate() {
        $.ajax({
            type: "GET",
            url: "http://localhost:8080/Hostel/product/date",
            data: {
                hid:  ${product.hid},
            ...
            success: function (data) {
                ...
                setTimeout(function () {
                    window.location.href = "http://localhost:8080/Hostel/product/date?hid=" + ${product.hid} +"&date=" + $("#js-date-input").val();
                }, 1000);
            },
            error: function () {
                toaster("服务器出现问题，请稍微再试！", "error");
