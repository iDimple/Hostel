...
public class CustomerController {
 ...
 // 我的消费
    @RequestMapping(value = "/user/analy", method = RequestMethod.GET)
    public ModelAndView analy(HttpSession session) {
        String vid = (String) session.getAttribute("vip_vid");
      //  VipInfo info = vipService.getVipById(vid);
        ModelAndView modelAndView = new ModelAndView("customer/analyseMember");
     //   modelAndView.addObject("msg", new Message(NumberFormater.formatDouble(info.getLevel().getIntegration())));
        return modelAndView;
    }
